...
import { RequestBody } from './WPPConnect'
...
export async function sendErrorPostReceive(
	...
	if (body?.error) {
		...
		const creds = await this.getCredentials('wppConnectApi');
...
export async function formatNumber(
	...
	delete requestOptions.body.numbers
	Object.assign(requestOptions.body as {}, { phone: numbers[0]});
